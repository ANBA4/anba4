...
anba.strain_field([1., 0., 0.,], [0., 0., 0.], "global", "paraview")
...
stress_result_file.write(anba.STRESS, t = 2.)
stress_result_file.write(anba.STRAIN, t = 3.)
...
print('Angolo di rotazione:', angle / np.pi * 180.)
